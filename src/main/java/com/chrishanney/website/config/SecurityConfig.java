...
import static com.chrishanney.website.constant.Constant.X_REQUESTED_WITH;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://localhost:80"));
